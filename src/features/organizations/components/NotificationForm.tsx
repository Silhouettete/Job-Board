              ...
              <FormItem>
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <FormDescription>
                      Receive emails about new job listings application
                    </FormDescription>
                  </div>
                  <FormControl>
                    <Switch
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Only receive notifications from candidates that meet or
                    exceed this rating. Candidates 3-5 starts should meet all
                    job requirements and are likely a good fit for this role.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
